...
| `AI_SAST_PR_SCAN_MAX_WORKERS` | Number of parallel workers for PR diff scanning (Vertex/Bedrock API calls). Higher values speed up large PRs but may hit rate limits. | `5` |
