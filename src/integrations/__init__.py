...
- Ollama: Local open-source LLM backend (alternative to Vertex AI)
...
__all__ = ['get_feedback_client', 'ScanDatabase', 'JiraClient', 'DatabricksClient', 'OllamaClient', 'VectorClient', 'NotificationClient']
